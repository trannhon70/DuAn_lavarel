...
@section('content')
    ...
    <div class="recommended_items">
        <!--recommended_items-->
        <h2 style="margin-top: 10px" class="title text-center">Sản phẩm liên quan</h2>
                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img style="height:150px;" src="{{ URL::to('/public/upload/product/'.$lienquan->product_image) }}" alt="" />
